        ...
        <?php if ($gmapsCode): ?>
          <a href="https://www.google.com/maps/dir/?api=1&destination=<?= e(rawurlencode($gmapsCode)) ?>&travelmode=walking"
            ...
            <div class="flex items-center gap-4">
              <span class="h-14 w-14 rounded-2xl bg-white/20 backdrop-blur flex items-center justify-center shrink-0 shadow-lg">
                <i data-lucide="navigation" class="size-[28px] text-white"></i>
              </span>
              <div class="flex-1 min-w-0">
              ...
              <i data-lucide="chevron-right" class="size-[24px] text-white/80 shrink-0 group-hover:translate-x-1 transition"></i>
            </div>
          </a>
        <?php elseif ($s['block_number']): ?>
          <div class="p-4 sm:p-5 bg-sky-50/60 dark:bg-sky-500/5 border-b border-sky-100 dark:border-sky-500/20 flex items-center gap-3">
            <span class="h-10 w-10 rounded-2xl bg-sky-500 text-white flex items-center justify-center shrink-0 shadow-md"><i data-lucide="map-pin" class="size-[20px]"></i></span>
            <div class="min-w-0 flex-1">
              <div class="font-display font-bold">Blocco <?= e($s['block_number']) ?></div>
              <div class="text-xs text-ink-500 mt-0.5">Domina Coral Bay · Sharm El Sheikh</div>
            </div>
          </div>
        <?php endif; ?>

        <?php if (trim($s['cleaner_directions'] ?? '')): ?>
          <div class="p-4 sm:p-5 bg-amber-50/60 dark:bg-amber-500/5 <?= $gmapsCode || $s['block_number'] ? 'border-t border-amber-100 dark:border-amber-500/20' : '' ?>">
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                <div class="font-display font-bold text-sm text-amber-900 dark:text-amber-200">Note di Patrizia</div>
