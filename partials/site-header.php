  ...
  <div class="container-wide h-[68px] flex items-center justify-between">
    ...
    <nav class="hidden md:flex items-center gap-1 text-sm font-medium">
      <?php foreach ([['/','Home'],['/appartamenti.php','Appartamenti'],['/noleggi.php','Noleggi'],['/escursioni.php','Escursioni'],['/transfer.php','Transfer'],['/contatti.php','Contatti']] as $n): ?>
        <a href="<?= e($n[0]) ?>" class="px-3 py-2 rounded-xl text-ink-700 dark:text-ink-300 hover:text-ink-900 dark:hover:text-white hover:bg-ink-100/70 dark:hover:bg-ink-800/60 transition"><?= e($n[1]) ?></a>
      <?php endforeach; ?>
    </nav>
...
<div x-data="{ open: false }" @toggle-menu.window="open = !open" x-show="open" x-cloak
  ...
  <div class="flex flex-col gap-1 mt-8 text-lg">
    <?php foreach ([['/','Home'],['/appartamenti.php','Appartamenti'],['/noleggi.php','Noleggi'],['/escursioni.php','Escursioni'],['/transfer.php','Transfer'],['/contatti.php','Contatti'],['/admin/login.php','Area admin']] as $n): ?>
