...
if ($count > 0 && !$reset) {
    ...
    $services = [
      ...
      ['slug'=>'golf-cart-naama-bay-4posti', 'type'=>'golf_cart', 'name'=>'Golf cart 4 posti · Naama Bay',
       ...
       'cover_image'=>'/assets/services/vehicle_golf_cart.svg',
       'gallery'=>json_encode(['/assets/services/vehicle_golf_cart.svg']),
      ...
      ['slug'=>'scooter-50cc', 'type'=>'scooter', 'name'=>'Scooter 50cc',
       ...
       'cover_image'=>'/assets/services/vehicle_scooter.svg',
       'gallery'=>json_encode(['/assets/services/vehicle_scooter.svg']),
      ...
      ['slug'=>'monopattino-elettrico', 'type'=>'escooter', 'name'=>'Monopattino elettrico',
       ...
       'cover_image'=>'/assets/services/vehicle_escooter.svg',
       'gallery'=>json_encode(['/assets/services/vehicle_escooter.svg']),
      ...
      ['slug'=>'transfer-aeroporto-naama-bay', 'type'=>'transfer', 'name'=>'Transfer aeroporto → Naama Bay',
       ...
       'cover_image'=>'/assets/services/vehicle_transfer.svg',
      ...
      ['slug'=>'transfer-minibus-7posti', 'type'=>'transfer', 'name'=>'Transfer minibus 7 posti',
       ...
       'cover_image'=>'/assets/services/vehicle_minibus.svg',
